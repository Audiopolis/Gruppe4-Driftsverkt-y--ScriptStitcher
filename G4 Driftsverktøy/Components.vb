...
#Region "FormatConverter"
    Public Class FormatConverter
        ...
        End Sub
        Public Shared Function GetBytesFromString(ByVal value As String) As Byte()
            Return New Text.UTF8Encoding(True).GetBytes(value)
        End Function
        ...
        Public Shared Function ExtractFileName(ByVal FilePath As String, ByVal KeepExtension As Boolean) As String
            ...
            Return Ret
        End Function
        Public Shared Function GetNumericBoolean(ByVal value As Boolean) As Integer
...
#End Region
    Public Class Loader
        ...
        Private Shared PendingOperations As New Dictionary(Of String, Integer) From {{"LoadTaskCategories", 0}, {"LoadTaskListInCategory", 0}, {"LoadTask", 0}, {"LoadRoutineCategories", 0}, {"LoadRoutineListInCategory", 0}, {"LoadRoutine", 0}, {"LoadScheduleCategories", 0}, {"LoadScheduleListInCategory", 0}, {"LoadSchedule", 0}, {"LoadTemplateList", 0}, {"LoadTemplate", 0}}
        ...
        Public Shared Sub RemoveSchedule(ByVal Name As String)
            ...
            Else
                ...
                AllTemplates.FindAll(Function(x As TemplateEntry) As Boolean
        ...
        Public Shared Sub RemoveRoutine(ByVal Name As String)
            ...
            Else
                ...
                Next
                AllSchedules.FindAll(Function(x As ScheduleEntry) As Boolean
        ...
        Public Shared Sub RemoveTask(ByVal Name As String)
            ...
            Else
                ...
                Next
                AllRoutines.FindAll(Function(x As RoutineEntry) As Boolean
        ...
        Public Overloads Shared Sub AddTemplate(Path As String)
            ...
            Else
                AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ReadLines(Path), AddressOf TemplateLoadedFromPath, Path.Clone)
            End If
        End Sub
        ...
        Public Overloads Shared Sub AddSchedule(Path As String)
            ...
            AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ReadLines(Path), AddressOf ScheduleLoadedFromPath, Path.Clone)
        End Sub
        ...
        Public Overloads Shared Sub AddRoutine(Path As String)
            ...
            AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ReadLines(Path), AddressOf RoutineLoadedFromPath, Path.Clone)
        End Sub
        ...
        Public Overloads Shared Sub AddTask(Path As String)
            ...
            AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ReadLines(Path), AddressOf TaskLoadedFromPath, Path.Clone)
        End Sub
        ...
        Public Shared Sub LoadTaskCategories(LoadTasksInEach As Boolean)
            If PendingOperations("LoadTaskCategories") = 0 Then
                ...
                AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ListDirectories(TaskEntry.BaseDirectory), AddressOf TaskCategoriesLoaded, Nothing)
            End If
        End Sub
        Private Shared Sub TaskCategoriesLoaded(e As FileOperationEventArgs)
            ...
            For Each Line As String In Result
                ...
                If varLoadTasksInEachCategory Then
                    ...
                    AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ListFiles(Line), AddressOf TaskListInCategoryLoaded, Nothing)
                End If
            Next
        End Sub
        Private Shared Sub TaskListInCategoryLoaded(e As FileOperationEventArgs)
            ...
            For Each Filename As String In TaskFiles
                ...
                AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ReadLines(Filename), AddressOf TaskLoaded, Filename.Clone)
            Next
        End Sub
        ...
        Public Shared Sub LoadRoutineCategories(LoadRoutinesInEach As Boolean)
            ...
            AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ListDirectories(RoutineEntry.BaseDirectory), AddressOf RoutineCategoriesLoaded, Nothing)
        End Sub
        Private Shared Sub RoutineCategoriesLoaded(e As FileOperationEventArgs)
            ...
            For Each Line As String In Result
                ...
                If varLoadRoutinesInEachCategory Then
                    ...
                    AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ListFiles(Line), AddressOf RoutineListInCategoryLoaded, Nothing)
                End If
            Next
        ...
        Private Shared Sub RoutineListInCategoryLoaded(e As FileOperationEventArgs)
            ...
            For Each Filename As String In RoutineFiles
                ...
                AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ReadLines(Filename), AddressOf RoutineLoaded, Filename.Clone)
            Next
        End Sub
        ...
        Private Shared Sub LoadScheduleCategories(LoadSchedulesInEach As Boolean)
            ...
            AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ListDirectories(ScheduleEntry.BaseDirectory), AddressOf ScheduleCategoriesLoaded, Nothing)
        End Sub
        Private Shared Sub ScheduleCategoriesLoaded(e As FileOperationEventArgs)
            ...
            For Each Line As String In Result
                ...
                If varLoadSchedulesInEachCategory Then
                    ...
                    AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ListFiles(Line), AddressOf ScheduleListInCategoryLoaded, Nothing)
                End If
            Next
        End Sub
        Private Shared Sub ScheduleListInCategoryLoaded(e As FileOperationEventArgs)
            ...
            For Each Filename As String In ScheduleFiles
                ...
                AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ReadLines(Filename), AddressOf ScheduleLoaded, Filename.Clone)
            Next
        End Sub
        ...
        Public Shared Sub LoadTemplates()
            If PendingOperations("LoadTemplateList") = 0 Then
                ...
                AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ListFiles(TemplateEntry.BaseDirectory), AddressOf TemplateListLoaded, Nothing)
            Else
                MsgBox("Please wait")
            End If
        End Sub
        Private Shared Sub TemplateListLoaded(e As FileOperationEventArgs)
            ...
            For Each File As String In TemplateFiles
                ...
                AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.ReadLines(File), AddressOf TemplateLoaded, New StringReference(File))
            Next
        End Sub
...
#Region "Categories"
    Public MustInherit Class ComponentEntry
        ...
        Public Overridable Sub ChangeCategoryAndMoveFile(ByVal NewCategoryName As String, WhenFinished As Action(Of FileOperationEventArgs), State As Object)
            If NewCategoryName <> CategoryName Then
                ...
                AsyncFileReader.OperationsQueue.AddOperation(AsyncFileReader.OperationsQueue.FileOperation.MoveFile(OldPath, NewPath, False), WhenFinished, State)
            End If
        End Sub
    ...
    Public MustInherit Class ChildComponentInformation
        ...
        Public Property Active As Boolean
            ...
            End Set
        End Property
        Protected Sub New(Name As String, Active As Boolean)
            varName = Name
            varActive = Active
        End Sub
    ...
    Public Class ScheduleInformation
        ...
        Public Shadows Function Copy() As ScheduleInformation
            Dim Ret As New ScheduleInformation(Name, Active) With {.MatchingEntryExists = MatchingEntryExists}
            Return Ret
        End Function
    End Class
    Public Class RoutineInformation
        ...
        Public Shadows Function Copy() As RoutineInformation
            Return New RoutineInformation(Name, RunEvery, Interval, Active, LastRun) With {.MatchingEntryExists = MatchingEntryExists}
        End Function
    ...
    Public Class TaskInformation
        ...
        Public Shadows Function Copy() As TaskInformation
            Return New TaskInformation(Name, Active, WaitForPrevious, RunAsync, Arguments) With {.MatchingEntryExists = MatchingEntryExists}
        End Function
    ...
    Public Class AsyncFileReader
        ...
        Public Shared Sub Start()
            If Not varIsRunning Then
                If OperationsQueue.NextInQueue IsNot Nothing Then
                    varIsRunning = True
                    ...
                    Dim Arguments() As Object = {OperationsQueue.NextInQueue.Operation, OperationsQueue.NextInQueue.State}
                    TS.Start(Arguments)
                End If
            End If
        End Sub
        Private Shared Function ExecuteOperation(Arguments As Object) As Object
            ...
            Dim varOperation As OperationsQueue.FileOperation = DirectCast(ArgArr(0), OperationsQueue.FileOperation)
        ...
        Private Shared Sub OperationFinished(Sender As Object, e As ThreadStarterEventArgs) Handles TS.WorkCompleted
            ...
            TS.Dispose()
            With OperationsQueue.NextInQueue
                OperationsQueue.RemoveFirst()
                If .WhenFinished IsNot Nothing Then .WhenFinished.Invoke(fe)
            End With
            varIsRunning = False
            Start()
        End Sub
        ...
        Public Class OperationsQueue
            ...
            Protected Friend Shared ReadOnly Property NextInQueue As OperationActionPair
                ...
                End Get
            End Property
            'Friend Shared ReadOnly Property Operations As List(Of OperationActionPair)
            '    Get
