...
Module PSClasses
    Public Class PSTask
#Region "Erklæringer"
        ' Vi benytter minst en klasse som tar i bruk uhåndterte ressurser (frigjøres med kall til Dispose())
        ' Derfor implementerer vi IDisposable; også for denne klassen må vi gjøre et kall for metoden Dispose() når vi er ferdige med instansen
        Implements IDisposable
        ' Stien (inkludert filnavn) til scriptet som (kanskje) vil kjøres
        Private varScriptLocation As String
        ' Et brukerdefinert navn for denne oppgaven til bruk i GUI
        Private varTaskDescriptiveName As String = "New task"
        ' Minimal versjon (godtar og returnerer data i form av Object) av en klasse som håndterer asynkron kjøring av rutiner/funksjoner og sikker levering av resultat
        Private WithEvents TaskRunner As Threader
        ' Spesifiserer om scriptet skal kjøres asynkront (multithreading) eller ikke
